function [ Z, k ] = kssc_exact( X, lambda, num_neighbors )
...
for k = 1 : max_iterations
    ...
    % Update Z
    Z  = solve_l1_spm(Z_prev - 1/rho * sparse(rows, cols, selmult_mt_m_fast(mu*X, X*Z_prev - X + E + 1/mu * Y, rows, cols), N, N), lambda/rho);
